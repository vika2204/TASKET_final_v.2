...
class AIService {
    ...
    static async askGPT (ticket) {
        ...
        try {
            const postData = {
                role: `Ты - проектный менеджер с большим опытом. Тебе будут присылать описание задач с названием и оценкой в часах. Твоя задача - отвечать лаконично в двух-трех предложениях, хорошо ли сформулирована задача, понятны ли требования, завышена ли по твоему мнению оценка. Отвечай ТОЛЬКО в следующем формате: "X Y", где X - это слово "ХОРОШО" или "ПЛОХО", в зависимости от наличия замечаний, а Y - твой анализ.`,
